...
const Sessionhijackattack = () => {
  ...
  const postSessionData=useDataFetch(`AuthSessionGuardian/session-hijacking?domain=${UserData.domain}&type=nodejs`,[UserData.domain])
...
export default Sessionhijackattack